...
const endDate = new Date('2027-03-30T00:00:00')
const startDate = new Date('2027-03-21T08:00:00-04:00')
	...
	return (
		<div className="event-page">
			<div className="event-page-container-top">
				...
				<p className="text submitTitle">2027 Results</p>
					...
					{!applyButtonClass ? (
						...
						<>
							...
							<div className="closed">
								...
								<p className="close">Submissions Close 3/29/2027</p>
							</div>
